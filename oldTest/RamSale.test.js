...
const RamCoin = artifacts.require('RamCoin');
const RamSale = artifacts.require('RamSale');
const RefundVault = artifacts.require('./RefundVault');
const TokenTimelock = artifacts.require('./TokenTimelock');

contract('RamSale', function([_, wallet, investor1, investor2, foundersFund, foundationFund, partnersFund]) {
    ...
    beforeEach(async function () {
        // Token config
        this.name = "CSU RamCoin Token";
        this.symbol = "RAMCOIN";
        this.decimals = 18;

        // Deploy Token
        this.token = await RamCoin.new(
            this.name,
            this.symbol,
            this.decimals
        );
        ...
        this.crowdsale = await RamSale.new(
            this.rate,
            this.wallet,
            this.token.address,
            this.cap,
    ...
    describe('minted crowdsale', function () {
        it('mints tokens after purchase', async function () {
            ...
            // console.log(newTotalSupply.toNumber()/1e18, originalTotalSupply.toNumber()/1e18);
